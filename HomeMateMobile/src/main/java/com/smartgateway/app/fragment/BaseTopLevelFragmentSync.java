...
import ru.johnlife.lifetools.fragment.BaseListFragmentSync;

/**
 * Created by yanyu on 5/16/2016.
 */
public abstract class BaseTopLevelFragmentSync<T extends AbstractData> extends BaseListFragmentSync<T> {
