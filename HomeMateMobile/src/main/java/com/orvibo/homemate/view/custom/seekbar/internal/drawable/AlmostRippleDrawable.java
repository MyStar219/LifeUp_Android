...
public class AlmostRippleDrawable extends com.orvibo.homemate.view.custom.seekbar.internal.drawable.StateDrawable implements Animatable {
    ...
    public AlmostRippleDrawable(@NonNull ColorStateList tintStateList) {
        ...
        mFocusedColor = getModulatedAlphaColor(255, mFocusedColor);
        mPressedColor = getModulatedAlphaColor(255, mPressedColor);
        mDisabledColor = getModulatedAlphaColor(255, mDisabledColor);
    }
