	...
	public void setPointState(int state) {
		...
		switch (state) {
			case Constants.POINT_STATE_NORMAL:
				this.image.setBackgroundResource(R.drawable.icon_hand_unselected);
				break;
			case Constants.POINT_STATE_SELECTED:
				this.image.setBackgroundResource(R.drawable.icon_hand_selected);
				break;
			case Constants.POINT_STATE_WRONG:
				this.image.setBackgroundResource(R.drawable.icon_hand_fault);
				break;
			default:
				break;
		}
