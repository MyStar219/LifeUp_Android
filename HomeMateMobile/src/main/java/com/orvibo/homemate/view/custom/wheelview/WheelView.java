...
public class WheelView extends TosGallery {
	 ...
	 * Shadow colors
	 */
//	private static final int[] SHADOWS_COLORS = { 0x99000000, 0x33000000,
//			0x000000 };

	private static final int[] SHADOWS_COLORS = { 0x00ffffff, 0x00ffffff,
	0x00ffffff };
	...
	private void initialize(Context context) {
		...
		this.setBackgroundResource(R.drawable.tran);
