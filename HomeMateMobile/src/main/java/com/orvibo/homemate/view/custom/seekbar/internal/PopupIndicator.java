...
package com.orvibo.homemate.view.custom.seekbar.internal;
...
public class PopupIndicator {
    ...
    //... phew!
    private com.orvibo.homemate.view.custom.seekbar.internal.drawable.MarkerDrawable.MarkerAnimationListener mListener;
    ...
    public void setListener(com.orvibo.homemate.view.custom.seekbar.internal.drawable.MarkerDrawable.MarkerAnimationListener listener) {
        mListener = listener;
    }
     ...
     * I wanted to use the {@link com.orvibo.homemate.view.custom.seekbar.internal.Marker} directly
     ...
     */
    private class Floater extends FrameLayout implements com.orvibo.homemate.view.custom.seekbar.internal.drawable.MarkerDrawable.MarkerAnimationListener {
        private com.orvibo.homemate.view.custom.seekbar.internal.Marker mMarker;
        private int mOffset;

        public Floater(Context context, AttributeSet attrs, int defStyleAttr, String maxValue) {
            super(context);
            mMarker = new com.orvibo.homemate.view.custom.seekbar.internal.Marker(context, attrs, defStyleAttr, maxValue);
        ...
        public void setFloatOffset(int x) {
            ...
            if (!com.orvibo.homemate.view.custom.seekbar.internal.compat.SeekBarCompat.isHardwareAccelerated(this)) {
                invalidate();
            }
        }
