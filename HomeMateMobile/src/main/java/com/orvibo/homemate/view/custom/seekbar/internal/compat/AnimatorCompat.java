 ...
 * </p>
 * <p>
 * This class is used to provide animation to the {@link com.orvibo.homemate.view.custom.seekbar.DiscreteSeekBar}
...
public abstract class AnimatorCompat {
    ...
    public static final AnimatorCompat create(float start, float end, AnimationFrameUpdateListener listener) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            return new com.orvibo.homemate.view.custom.seekbar.internal.compat.AnimatorCompatV11(start, end, listener);
        } else {
