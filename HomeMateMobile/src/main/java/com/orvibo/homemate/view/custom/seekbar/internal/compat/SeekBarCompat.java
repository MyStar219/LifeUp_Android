...
package com.orvibo.homemate.view.custom.seekbar.internal.compat;
...
import com.orvibo.homemate.view.custom.seekbar.internal.drawable.AlmostRippleDrawable;
...
public class SeekBarCompat {
     ...
     */
    public static void setOutlineProvider(View view, final com.orvibo.homemate.view.custom.seekbar.internal.drawable.MarkerDrawable markerDrawable) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            com.orvibo.homemate.view.custom.seekbar.internal.compat.SeekBarCompatDontCrash.setOutlineProvider(view, markerDrawable);
        }
    }
