...
public abstract class TosAdapterView<T extends Adapter> extends ViewGroup {
    ...
    /**
     * View to showPopup if there are no items to showPopup.
     */
    ...
    /**
     * Sets the view to showPopup if the adapter is empty
     */
     ...
     * this AdapterView.
     * 
     * @return The view to showPopup if the adapter is empty.
     */
