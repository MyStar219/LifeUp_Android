...
public class ActionSTBControllerActivity extends BaseActionActivity implements IrButton.OnCheckedResultListener {
    ...
    private static final String TAG = ActionSTBControllerActivity.class
            .getSimpleName();
    ...
    private void init() {
        mContext = ActionSTBControllerActivity.this;
    }
    ...
    private void initData() {
        ...
        for (final IrButton irButton : irNoButtons) {
            irButton.initStatus(ActionSTBControllerActivity.this, uid, userName, deviceId);
        }
    }
