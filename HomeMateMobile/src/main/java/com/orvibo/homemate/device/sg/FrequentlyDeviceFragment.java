 ...
 */
public class
FrequentlyDeviceFragment extends BaseFragment implements OnNewPropertyReportListener,
    ...
    private static final String TAG = FrequentlyDeviceFragment.class.getSimpleName();
...
//    private QueryUnbinds queryUnbinds;
    ...
    public static FrequentlyDeviceFragment newInstance(boolean hideToolbar, boolean hideWeather) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("hide_toolbar", hideToolbar);
        bundle.putBoolean("hide_weather", hideWeather);
        FrequentlyDeviceFragment fragment = new FrequentlyDeviceFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            hideWeather = getArguments().getBoolean("hide_weather");
        }
...
//        refWatcher.watch(this);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View parentView = inflater.inflate(R.layout.fragment_devices,
                container, false);
        ...
        tipView = getActivity().getLayoutInflater().inflate(R.layout.item_devices_adpter_tip, null, false);
...
//        }.start();
    ...
    public void onClick(View v) {
        ...
        if (vId == R.id.classification_item) {
            ...
            intent.putExtra(IntentKey.INTENT_SOURCE, FrequentlyDeviceFragment.class.getSimpleName());
            intent.putExtra(IntentKey.DEVICE, device);
            startActivity(intent);
            ...
            switch (msg.what) {
                case WHAT_REFRESH_DEVICES:
                    ...
                    if (mSelectRoomPopup != null && mSelectRoomPopup.isEmptyRoom()) {
                        ...
                        mArrow_iv.setVisibility(View.GONE);
                        mSelectRoom_ll.setOnClickListener(FrequentlyDeviceFragment.this);
                    }
                    Bundle bundle = msg.getData();
                ...
                if (sHandler != null) {
                    ...
                    if (mDevicesAdapter == null) {
                        ...
                        mDevicesAdapter = new DevicesAdapter(context, tempDevices, new ArrayList<List<Device>>(),
                                statuses, FrequentlyDeviceFragment.this, mControlRecord);
                    } else {
...
//        List<Device> devices = mDeviceDao.selDevicesByCommonFlag(UserCache.getCurrentUserId(context), CommonFlag.COMMON);
    ...
    private void showEmptyView(boolean isEmpty) {
        ...
        mDevices_lv.setVisibility(isEmpty ? View.GONE : View.VISIBLE);
