...
public class BaseFragment2 extends Fragment implements OnClickListener, DialogFragmentTwoButton.OnTwoButtonClickListener {
    public static final String TAG = BaseFragment2.class.getSimpleName();
